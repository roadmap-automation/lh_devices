...
class RinseSystemBase(InjectionChannelBase, LayoutPlugin):
    ...
    def __init__(self,
        ...
        if self.layout is None:
            ...
            rinse_rack = Rack(columns=3, rows=2, max_volume=2000, min_volume=200.0, style='staggered', wells=[], height=300, width=600, x_translate=300, y_translate=0, shape='circle', editable=True)
            carrier_rack = Rack(columns=1, rows=1, max_volume=2000, min_volume=200.0, style='grid', wells=[], height=300, width=300, x_translate=0, y_translate=0, shape='rect', editable=True)
